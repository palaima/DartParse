...
part 'src/operation/SetOperation.dart';
part 'src/operation/DeleteOperation.dart';
part 'src/operation/RemoveOperation.dart';
part 'src/operation/IncrementOperation.dart';
part 'src/operation/AddOperation.dart';
part 'src/operation/AddUniqueOperation.dart';
part 'src/operation/RelationOperation.dart';
